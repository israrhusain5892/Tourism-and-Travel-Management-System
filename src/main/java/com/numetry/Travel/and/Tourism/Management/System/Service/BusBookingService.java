...
import com.numetry.Travel.and.Tourism.Management.System.Model.*;
...
//                  busBooking.setSelectedRouteId(route.getId());
...
//                  Route getRoute=routeRepository.findById(saved.getSelectedRouteId()).get();
//                  RouteDTO routeDTO=modelMapper.map(getRoute,RouteDTO.class);
//                  busBookingDto.setBookRoute(routeDTO);
